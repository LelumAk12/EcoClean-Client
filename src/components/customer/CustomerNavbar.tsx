  ...
  useEffect(() => {
    const fetchPoints = async () => {
      ...
      try {
        ...
        const bookingsRes = await fetch(`${backendUrl}/api/user/all-bookings`, {
          method: 'GET',
          headers: {
        ...
        const pickupsRes = await fetch(`${backendUrl}/api/user/get-all-pickup-request`, {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/json',
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      ...
      try {
        ...
        const token = await getToken();
        if (!token) throw new Error('No authentication token available');
        const response = await fetch(`${backendUrl}/api/user/get-All-notifications`, {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/json',
